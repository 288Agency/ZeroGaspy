...
export const CHALLENGES: ChallengeDefinition[] = [
  ...
  {
    id: 'consume_5',
    nameKey: 'challenges.names.consume5',
    descriptionKey: 'challenges.descriptions.consume5',
    icon: '🍎',
    category: 'saving',
    difficulty: 'easy',
    xpReward: XP_REWARDS.easy,
  ...
  {
    id: 'add_10',
    nameKey: 'challenges.names.add10',
    descriptionKey: 'challenges.descriptions.add10',
    icon: '🛒',
    category: 'adding',
    difficulty: 'easy',
    xpReward: XP_REWARDS.easy,
  ...
  {
    id: 'recipes_5',
    nameKey: 'challenges.names.recipes5',
    descriptionKey: 'challenges.descriptions.recipes5',
    icon: '🍳',
    category: 'recipes',
    difficulty: 'easy',
    xpReward: XP_REWARDS.easy,
  ...
  {
    id: 'streak_3',
    nameKey: 'challenges.names.streak3',
    descriptionKey: 'challenges.descriptions.streak3',
    icon: '⭐',
    category: 'streak',
    difficulty: 'easy',
    xpReward: XP_REWARDS.easy,
  ...
  {
    id: 'save_10',
    nameKey: 'challenges.names.save10',
    descriptionKey: 'challenges.descriptions.save10',
    icon: '🛡️',
    category: 'saving',
    difficulty: 'medium',
    xpReward: XP_REWARDS.medium,
  ...
  {
    id: 'add_20',
    nameKey: 'challenges.names.add20',
    descriptionKey: 'challenges.descriptions.add20',
    icon: '📥',
    category: 'adding',
    difficulty: 'medium',
    xpReward: XP_REWARDS.medium,
  ...
  {
    id: 'recipes_7',
    nameKey: 'challenges.names.recipes7',
    descriptionKey: 'challenges.descriptions.recipes7',
    icon: '📚',
    category: 'recipes',
    difficulty: 'medium',
    xpReward: XP_REWARDS.medium,
  ...
  {
    id: 'daily_6',
    nameKey: 'challenges.names.daily6',
    descriptionKey: 'challenges.descriptions.daily6',
    icon: '🗓️',
    category: 'daily',
    difficulty: 'medium',
    xpReward: XP_REWARDS.medium,
  ...
  {
    id: 'add_varied_4',
    nameKey: 'challenges.names.addVaried4',
    descriptionKey: 'challenges.descriptions.addVaried4',
    icon: '🧺',
    category: 'variety',
    difficulty: 'medium',
    xpReward: XP_REWARDS.medium,
  ...
  {
    id: 'add_30',
    nameKey: 'challenges.names.add30',
    descriptionKey: 'challenges.descriptions.add30',
    icon: '💪',
    category: 'adding',
    difficulty: 'hard',
    xpReward: XP_REWARDS.hard,
  ...
  {
    id: 'recipes_20',
    nameKey: 'challenges.names.recipes20',
    descriptionKey: 'challenges.descriptions.recipes20',
    icon: '🍽️',
    category: 'recipes',
    difficulty: 'hard',
    xpReward: XP_REWARDS.hard,
  ...
  {
    id: 'streak_7',
    nameKey: 'challenges.names.streak7',
    descriptionKey: 'challenges.descriptions.streak7',
    icon: '🎯',
    category: 'streak',
    difficulty: 'hard',
    xpReward: XP_REWARDS.hard,
  ...
  for (let i = 0; i < state.challenges.length; i++) {
    ...
    switch (def.trackingType) {
      case 'count': {
        ...
        if ((def.id === 'save_5' || def.id === 'save_10' || def.id === 'save_20') && action.type === 'food_consumed') {
