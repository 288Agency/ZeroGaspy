...
> **OBLIGATOIRE:** À chaque fin de session ou après une modification significative, Codex DOIT mettre à jour Notion pour garder le suivi en temps réel.
...
| Modification code par Codex | → Mise à jour manuelle Notion (voir règles ci-dessus) |
